...
class Apple(GameObject):
    ...
    def randomize_position(self, snake_positions):
        ...
        Передается список позиций змейки для избежания пересечений
        """
        while True:
...
class Snake(GameObject):
    """Класс змейки, которым управляет игрок"""
    ...
    def move(self):
        ...
        if next_position in self.positions[1:]:
            self.reset()
